...
export function InfiniteSlider({
  ...
  // Support both duration-based and speed-based APIs
  const effectiveDuration = duration ?? (speed ? 1000 / speed : 25);
  const effectiveDurationOnHover = durationOnHover ?? (speedOnHover ? 1000 / speedOnHover : undefined);
